...
export default function ConstantInnovation() {
  ...
  return (
    <section className="py-12 bg-blue-50 dark:bg-slate-900 relative">
      <div className="w-full relative group">
        {/* Halation glow effect similar to the Hero video - visible only on hover */}
        <div className="absolute -inset-8 bg-gradient-to-r from-cyan-500/40 via-blue-400/30 to-cyan-500/40 blur-[60px] opacity-0 group-hover:opacity-80 transition-opacity duration-700 pointer-events-none dark:mix-blend-screen"></div>
        <div className="absolute -inset-2 bg-blue-500/20 blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-700 pointer-events-none"></div>

        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-primary dark:bg-primary-dark border-y border-white/10 shadow-2xl p-10 lg:p-16 relative overflow-hidden z-10"
        >
